  ...
  Future<void> _showAlert(String title, String message) async {
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text personally identifiable information (title),
...
System: <xaiArtifact artifact_id="6a1e1767-a3a8-46cf-a3cd-325497af8497" artifact_version_id="4c2b392f-1fa2-4482-97a9-16309e294aa3" title="create_requirement_form.dart" contentType="text/x-dart">
import 'dart:convert';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:intl/intl.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.blueAccent, // Blue accent header background
      ),
            ...
            children: [
              CustomDropdown(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.sports, color: Colors.blueGrey),
                ),
                itemStyle: const TextStyle(color: Colors.pink),
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelStyle: TextStyle(color: Colors.blueGrey),
                  prefixIcon: Icon(Icons.meeting_room, color: Colors.blueGrey),
                ),
              ),
              CustomDropdown(
                label: 'City',
              ...
              CustomDropdown(
                ...
                decoration: const InputDecoration(
                  labelText: 'Type',
                  labelStyle: TextStyle(color: Colors.blueGrey),
                  prefixIcon: Icon(Icons.payment, color: Colors.blueGrey),
                ),
                itemStyle: const TextStyle(color: Colors.pink),
              ),
              ...
              ListTile(
                title: Text(
                  _selectedDate != null ? "Date: ${DateFormat('yyyy-MM-dd').format(_selectedDate!)}" : "Select Date",
